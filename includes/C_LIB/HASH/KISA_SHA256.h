...
*/
CLIB_API void SHA256_Init( OUT SHA256_INFO *Info );
...
*/
CLIB_API void SHA256_Process( OUT SHA256_INFO *Info, IN const BYTE *pszMessage, IN UINT uDataLen );
...
@param pszDigest : 암호문
*/
CLIB_API void SHA256_Close( OUT SHA256_INFO *Info, OUT BYTE *pszDigest );
...
*/
CLIB_API void SHA256_Encrpyt( IN const BYTE *pszMessage, IN UINT uPlainTextLen, OUT BYTE *pszDigest );
